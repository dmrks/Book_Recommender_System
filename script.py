...
book_ratings['rating'] = book_ratings['rating']!=0
...
trainset, testset =train_test_split(rec_data, test_size=.2, random_state=42)
...
#8. Evaluate the recommender system = RMSE: 0.1512
...
#9. Prediction on a user who gave the "The Three-Body Problem" a rating of 5  = What rating does the algorithm predict this user will give the science-fiction book “The Martian” (book_id=18007564)? -> 1
